...
<table border = "1" style="height:100% ; width:100% ">
	<tr>
		...
		<input type="radio" name="user_activity_type" id = "by_attendee" value="byAttendeeList" onclick = "showhide('byAttendeeList');"/>Settle by Attendee list<br>
		<input type="radio" name="user_activity_type" id = "by_friend" value="byFriend" onclick = "showhide('byFriend');"/>Settle by Friends<br>
		...
		<div id='ByFriendDiv' style="display: none;"> 
			...
			Enter no of friends to Settle with: <input type ='text' id ="friendNo" size='2' name="friendno" >
			<input type="submit">
			</form>
		</div>	
		</td>
